...
router
  ...
  .get('/pessoas/:estudante_id/matriculas/confirmadas', (req, res) => matriculaController.getMatriculaPorEstudante(req, res))
  .get('/pessoas/matriculas/full', (req, res) => matriculaController.getCursosLotados(req, res))
